...
jQuery(function ($) {
    ...
    // Keep Google Pay / Apple Pay hosted-fields buttons in sync with the checkout total.
    // On load and on every checkout change: hide buttons instantly, push updated total
