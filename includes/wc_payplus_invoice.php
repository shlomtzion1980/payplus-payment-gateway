...
class PayplusInvoice
{
    ...
    public function __construct()
    {
        ...
        $this->payplus_invoice_api_key = isset($this->payplus_gateway_option['api_test_mode']) && $this->payplus_gateway_option['api_test_mode'] === 'yes' ? $this->payplus_gateway_option['dev_api_key'] ?? null : $this->payplus_gateway_option['api_key'];
        $this->payplus_invoice_secret_key = isset($this->payplus_gateway_option['api_test_mode']) && $this->payplus_gateway_option['api_test_mode'] === 'yes' ? $this->payplus_gateway_option['dev_secret_key'] ?? null : $this->payplus_gateway_option['secret_key'];
        ...
        $this->payplus_invoice_brand_uid = isset($this->payplus_gateway_option['api_test_mode']) && $this->payplus_gateway_option['api_test_mode'] === 'yes' ? $this->payplus_invoice_option['payplus_invoice_brand_uid_sandbox'] : $this->payplus_invoice_brand_uid;
