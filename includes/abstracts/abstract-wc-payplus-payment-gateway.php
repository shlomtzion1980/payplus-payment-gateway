...
abstract class WC_PayPlus_Payment_Gateway extends WC_Payment_Gateway_CC
{
    ...
    static function payplus_Add_log_payplus($last_error)
    {
    ...
    static function payplus_create_table_order()
    {
     ...
     * @return void
     */
    static function payplus_create_table_change_status_order()
    {
    ...
    static function payplus_create_table_log()
    {
    ...
    static function payplus_create_table_payment_session()
    {
        global $wpdb;
     ...
     * @return void
     */
    static function payplus_create_table_process()
    {
        global $wpdb;
    ...
    static function payplus_create_table_db()
    {

        if (PAYPLUS_VERSION_DB != get_option('payplus_db_version')) {

            WC_PayPlus_Payment_Gateway::payplus_create_table_order();
            WC_PayPlus_Payment_Gateway::payplus_create_table_change_status_order();
            WC_PayPlus_Payment_Gateway::payplus_create_table_log();
            WC_PayPlus_Payment_Gateway::payplus_create_table_payment_session();
            WC_PayPlus_Payment_Gateway::payplus_create_table_process();
    ...
    static function payplus_check_table_exist_db($nameTable)
    {
