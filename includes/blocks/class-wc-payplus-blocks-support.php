...
class WC_Gateway_Payplus_Payment_Block extends AbstractPaymentMethodType
{
    ...
    public function hostedFieldsData($order_id, $isPlaceOrder = false)
    {
        ...
        if (is_int($order_id)) {
            ...
            } elseif (!empty($options['vat_number_field']) && $order->get_meta($options['vat_number_field'])) {
                $data->customer->vat_number = $order->get_meta($options['vat_number_field']);
            }
    ...
    public function get_payment_method_data()
    {
        ...
        return [
            ...
            'showIframeRedirectLoader' => isset($this->payPlusSettings['show_iframe_redirect_loader']) && $this->payPlusSettings['show_iframe_redirect_loader'] === 'yes',
