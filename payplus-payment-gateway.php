...
class WC_PayPlus
{
    ...
    private function __construct()
    {
        ...
        add_action('woocommerce_thankyou', [$this, 'custom_thankyou_content'], 10, 1);
        add_action('wp_ajax_payplus-save-token', [$this, 'ajax_payplus_save_token']);
    ...
    public function ajax_payplus_save_token()
    {
    ...
    public function custom_thankyou_content($order_id)
    {
        ...
        // call custom js file
        wp_register_script('custom-js', PAYPLUS_PLUGIN_URL . '/assets/js/custom.js', ['jquery'], time(), true);
        wp_localize_script(
            'custom-js',
